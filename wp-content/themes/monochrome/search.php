...
<div id="headline">
  <p><?php _e('Search results for ', 'monochrome'); echo '&#8216;<span id="search_keyword"> ' .$s. ' </span>&#8217;'; ?><span id="search_hit"> - <?php $my_query =& new WP_Query("s=$s & showposts=-1"); echo $my_query->post_count; _e(' hit', 'monochrome'); ?></span></p>	
</div>
