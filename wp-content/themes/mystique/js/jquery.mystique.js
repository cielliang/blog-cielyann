...
jQuery(document).ready(function ($) {
  ...
  jQuery("a.reply").click(function () {
    ...
    jQuery("a.cancel-reply").css('display','block');
    jQuery("#respond").appendTo('#comment-body-'+targetID).slideFade('show',333,'easeOutQuart',function(){
  ...
  // cancel-reply
  jQuery("a.cancel-reply").click(function (event) {
    jQuery("#respond").hide();
    jQuery('#comment_parent').attr('value','0');
    //  jQuery('#comment_post_ID').attr('value',postID);

    jQuery("a.cancel-reply").css('display','none');
...
//  jQuery("a.cancel-reply").click(function () {
//    comment_id = jQuery(this).attr('href');
//    target = comment_id.slice(comment_id.search('-') + 1, comment_id.length);
//    jQuery('#reply-' + target).slideUp(333);
//    jQuery("#captcha").appendTo('#reply-' + target.parent());
//  });



//  // reply/cancel-reply (pligg only)
//  jQuery("a.reply").click(function () {
//    comment_id = jQuery(this).attr('href');
//    target = comment_id.slice(comment_id.search('-') + 1, comment_id.length);
//    jQuery('#reply-' + target).slideFade('toggle',333,'easeOutQuart');
//  });
//  jQuery("a.cancel-reply").click(function () {
//    comment_id = jQuery(this).attr('href');
//    target = comment_id.slice(comment_id.search('-') + 1, comment_id.length);
