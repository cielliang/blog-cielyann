...
<div id="post-<?php the_ID(); ?>" <?php post_class('clearfix preview-'.$post_preview); ?>>
 ...
 <h2 class="title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:','mystique'); echo ' '; the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
 ...
 <?php if($post_preview<>'title'): ?>
   <div class="post-content clearfix">
    ...
    if(is_search()):
     ...
     $content = preg_replace('/('.implode('|', $keys) .')/iu','<span class="altText highlight">\0</span>',$content);
     echo $content;
    else:
