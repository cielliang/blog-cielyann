...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'markup', 'gallery:themes/slider/templates/theme.tpl', 12, false),array('modifier', 'default', 'gallery:themes/slider/templates/theme.tpl', 12, false),)), $this); ?>
...
"/>
<?php if ($this->_tpl_vars['theme']['pageType'] == 'album' || $this->_tpl_vars['theme']['pageType'] == 'photo'): ?><?php echo '
<style type="text/css">
...
<?php echo $this->_reg_objects['g'][0]->theme(array('include' => "slider.tpl"), $this);?>
...
<?php elseif ($this->_tpl_vars['theme']['useFullScreen']): ?>
